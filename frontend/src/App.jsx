...
function App() {
  ...
  const fetchAll = async (tk, per) => {
    setLoading(true);
    setError("");
    setReport(""); // clear old report when searching a new company
    try {
        ...
        {company && (
          <div style={styles.card}>
            ...
            <div style={styles.grid}>
              ...
              <Metric
                label="Current Price"
                value={company.current_price ? `$${company.current_price}` : "N/A"}
              />
              <Metric
                label="P/E (Trailing)"
                value={company.pe_trailing ? company.pe_trailing.toFixed(2) : "N/A"}
              />
              <Metric
                label="P/E (Forward)"
                value={company.pe_forward ? company.pe_forward.toFixed(2) : "N/A"}
              />
            </div>
...
const styles = {
  ...
  input: {
    flex: 1, padding: "12px 16px", fontSize: "16px", borderRadius: "8px",
  ...
  card: {
    marginTop: "30px", padding: "24px", borderRadius: "12px",
    background: "#1e293b", border: "1px solid #334155",
  },
  cardName: { margin: 0, fontSize: "24px" },
  cardTicker: {
    fontSize: "14px", color: "#60a5fa", background: "#1e3a5f",
  ...
  chartTitle: { margin: 0, fontSize: "18px" },
  ...
  reportBtn: {
    padding: "8px 18px", fontSize: "14px", borderRadius: "8px", border: "none",
    background: "#3b82f6", color: "white", cursor: "pointer", fontWeight: "600",
  },
